// Nav + chrome icons for the v2 shell, traced from the PhotoSphere.dc.html
// prototype's inline SVGs (same viewBox/paths, same stroke conventions).

import type { ReactNode } from "react";

type IconProps = { size?: number };

function Base({ size = 17, children }: IconProps & { children: ReactNode }) {
  return (
    <svg
      width={size}
      height={size}
...
export function BrowseIcon(p: IconProps) {
  return (
    <Base {...p}>
...
export function UploadIcon(p: IconProps) {
  return (
    <svg width={p.size ?? 17} height={p.size ?? 17} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round">
      <path d="M12 16V4m-6 6 6-6 6 6M4 20h16" />
    </svg>
  );
}

export function OrganizeIcon(p: IconProps) {
  return (
    <Base {...p}>
...
export function PlacesIcon(p: IconProps) {
  return (
    <Base {...p}>
...
export function ExportIcon(p: IconProps) {
  return (
    <Base {...p}>
      <path d="M12 4v12m6-6-6 6-6-6M4 20h16" />
    </Base>
  );
}
...
export function ManagePlanIcon(p: IconProps) {
  return (
    <Base {...p}>
